...
class GradCAM:
    def __init__(self, model, classIdx, layerName=None):
        # model - A TensorFlow model which we'll use to compute a heatmap
        # classIdx- a specific class index that we will use to measure our class activation heatmap
        # layerName- layerName of the model in case we want to visualize the heatmap of a specific layer of our CNN;
